...
%5. Structure spéciale: Étude théorique = descriptif
%6. Pas d'hypothèse
...
%%% La distribution est l'espace géographique où l'espèce se trouve
...
\begin{frame}{Contexte\hskip 1em \mdseries{\textcolor{lightgray}{Difficultés reliées au contexte}}}
  ...
  Les \textbf{modèles de distribution d'espèces} (SDMs) font de nombreuses suppositions:
    \begin{itemize}
      ...
      \item Réponse linéaire et instantanée aux changements climatiques.
    \end{itemize}
...
\begin{frame}{Objectifs\hskip 1em \mdseries{\textcolor{lightgray}{}}}

  \textbf{Objectif général:} Évaluer les impacts des changements climatiques sur la distribution régionale d'une espèce en interaction avec un habitat en modification.

  \begin{figure}
    \includegraphics[height=.50\paperheight]{figs/monarque.jpg}
  \end{figure}

\end{frame}

%% Interaction: L'habitat --> arbre est une espèce
%% Eg. Monarque a besoin de l'asclépiade(habitat); ne peut pas se déplacer
%% Eg. Tamias - chêne; ail des bois - érables
...
\begin{frame}{Théorie\hskip 1em \mdseries{\textcolor{lightgray}{La niche écologique}}}
  ...
  \begin{columns}[]
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \includegraphics[width=0.8\textwidth]{figs/pulliam1.png}
      \end{figure}
    \end{column}
...
\begin{frame}{Théorie\hskip 1em \mdseries{\textcolor{lightgray}{La niche écologique}}}
  ...
  \begin{columns}[]
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \includegraphics[width=0.8\textwidth]{figs/pulliam2.png}
      \end{figure}
    \end{column}
...
%% Ajout de processus biotiques (vs. abiotiques)
  ...
  \begin{columns}
    ...
    \only<2>{%
      \begin{column}{0.5\textwidth}
        ...
        \vspace{1em}
        \begin{description}
          \item[P] proportion des patch occuppées
          \item[c] taux de colonisation
          \item[h] disponibilité de l'habitat
          \item[e] taux d'extinction
        \end{description}
      \end{column}
    }
  \end{columns}
...
\begin{frame}{Théorie\hskip 1em \mdseries{\textcolor{lightgray}{Métapopulations}}}
  ...
  \begin{equation*}
    \textcolor{lightgray}{\underbrace{b(E^*)}_{\text{naissances}} - \underbrace{d(E^*)}_{\text{mortalité}} = 0}
  \end{equation*}

  \begin{equation*}
    \underbrace{c(E^*)}_{\text{colonisations}} * \underbrace{h(E^*)}_{\text{disponibilité d'habitat}} - \underbrace{e(E^*)}_{\text{extinctions}} = 0
  \end{equation*}

  \begin{description}
    \item[E*:] ensemble des conditions environementales à la limite de distribtution
  \end{description}
...
\begin{frame}{Théorie\hskip 1em \mdseries{\textcolor{lightgray}{Métapopulations}}}
  ...
  La \textbf{capacité de métapopulation} est une mesure de la structure de l'habitat, c'est un proxy de la \emph{viabilité}
...
\begin{frame}{Étude de cas\hskip 1em \mdseries{\textcolor{lightgray}{Les Appalaches et la paruline rayée}}}
...
\begin{columns}
  ...
  \begin{column}{0.4\textwidth}
    ...
    %  \begin{column}{0.5\textwidth}
        \begin{figure}
        	\includegraphics[height=0.25\textheight]{figs/paruline_rayée.jpg}
        \end{figure}
    %  \end{column}
    %  \begin{column}{0.5\textwidth}
    %    \begin{figure}
    %	    \includegraphics[height=0.23\textheight]{figs/grive_des_bois.jpg}
    %    \end{figure}
    %  \end{column}
    %\end{columns}

    \begin{figure}
    	\includegraphics[height=0.45\textheight]{figs/corridor.jpg}
    \end{figure}
  \end{column}
...
\begin{frame}{Objectifs\hskip 1em \mdseries{\textcolor{lightgray}{}}}
  ...
  \textbf{Objectif général:} Évaluer les impacts des changements climatiques sur la distribution d'espèces associées à un habitat en modification telle que la \emph{paruline rayée}.

  \textbf{\\Objectifs spécifiques:}
  \begin{enumerate}
    \item Développer un outil théorique pour améliorer la prédiction des impacts des changements climatiques sur la distribution d'espèces associées à un habitat en modification;
    \item Évaluer l'impact des interactions biotiques sur la réaction des aires de distribution aux changements climatiques.
  \end{enumerate}
...
\begin{frame}[t]{Approche\hskip 1em \mdseries{\textcolor{lightgray}{L'impact des interactions}}}
  ...
  3. Mesurer la \textbf{capacité de métapopulation}.
...
\begin{frame}{Contributions\hskip 1em \mdseries{\textcolor{lightgray}{}}}
  ...
  \begin{itemize}
    \item Une meilleure compréhension de \textbf{l'effet des interactions} sur la réponse des espèces face aux changements climatiques;
...
\begin{frame}{Appendice\hskip 1em \mdseries{\textcolor{lightgray}{Réactivité}}}

  \begin{description}
    \item[S:] réactivité (vitesse) de l'espèce aux changements climatiques
  \end{description}
